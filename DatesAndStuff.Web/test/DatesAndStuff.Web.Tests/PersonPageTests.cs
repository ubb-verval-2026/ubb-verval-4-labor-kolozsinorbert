...
public class PersonPageTests
{
    ...
    [Test]
    public void Person_SalaryIncrease_ShouldIncrease([Random(-10, 100, 5)]int salaryIncreasePercentage)
    {
        // Arrange
        ...
        while (stale)
        {
            ...
            try
            {
                ...
                driver.FindElement(By.XPath("//*[@data-test='SalaryIncreasePercentageInput']")).SendKeys(salaryIncreasePercentage.ToString());
            }
